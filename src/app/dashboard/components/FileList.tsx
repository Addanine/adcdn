            ...
            <tr key={file.id} className="hover:bg-catppuccin-surface0">
              ...
              <td className="whitespace-nowrap px-6 py-4 text-sm">
                <div className="flex items-center space-x-4">
                  {file.shareLink ? (
                    <button
                      onClick={() => copyToClipboard(file.shareLink!, file.id)}
                    ...
                    >
                      ...
                      {copiedLink === file.id ? 'Copied!' : 'Copy Link'}
                    </button>
                  ) : (
                    <button
                      onClick={() => createShareableLink(file.id)}
                      disabled={creatingShareLink === file.id}
                  ...
                  <button
                    ...
                    className="flex items-center text-catppuccin-red hover:text-catppuccin-maroon"
                    title="Delete file"
                  >
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
